...
void restricting() {
    ...
    // 0000
    if (Tracking_Left1Value == LOW && Tracking_Left2Value == LOW && Tracking_Right1Value == LOW && Tracking_Right2Value == LOW) {
        printf("RES1\n");
        printf("%d %d %d %d\n", Tracking_Left1Value, Tracking_Left2Value, Tracking_Right1Value, Tracking_Right2Value);
        Car_Spin_Right(75, 75);
        usleep(1000000);
    }
    // 1X00
    else if (Tracking_Left1Value == HIGH && Tracking_Right1Value == LOW && Tracking_Right2Value == LOW) {
        printf("RES2\n");
        printf("%d %d %d %d\n", Tracking_Left1Value, Tracking_Left2Value, Tracking_Right1Value, Tracking_Right2Value);
        Car_Spin_Left(70, 70);
        usleep(1000000);
    ...
    // 00X1
    else if (Tracking_Left1Value == LOW && Tracking_Left2Value == LOW && Tracking_Right2Value == HIGH) {
        printf("RES3\n");
        printf("%d %d %d %d\n", Tracking_Left1Value, Tracking_Left2Value, Tracking_Right1Value, Tracking_Right2Value);
    ...
    // 10X1
    else if (Tracking_Left1Value == HIGH && Tracking_Left2Value == LOW && Tracking_Right2Value == HIGH) {
        printf("RES4\n");
        printf("%d %d %d %d\n", Tracking_Left1Value, Tracking_Left2Value, Tracking_Right1Value, Tracking_Right2Value);
        Car_Spin_Right(70, 70);
        usleep(1000000);
    ...
    // 1X01
    else if (Tracking_Left1Value == HIGH && Tracking_Right1Value == LOW && Tracking_Right2Value == HIGH) {
        printf("RES5\n");
        printf("%d %d %d %d\n", Tracking_Left1Value, Tracking_Left2Value, Tracking_Right1Value, Tracking_Right2Value);
        Car_Spin_Right(70, 70);
        usleep(1000000);
    ...
    // 0110
    else if (Tracking_Left1Value == LOW && Tracking_Left2Value == HIGH && Tracking_Right1Value == HIGH && Tracking_Right2Value == LOW) {
        printf("RES6\n");
        printf("%d %d %d %d\n", Tracking_Left1Value, Tracking_Left2Value, Tracking_Right1Value, Tracking_Right2Value);
        Car_Spin_Right(70, 70);
        usleep(1000000);
    ...
    // 0111
    else if (Tracking_Left1Value == LOW && Tracking_Left2Value == HIGH && Tracking_Right1Value == HIGH && Tracking_Right2Value == HIGH) {
        printf("RES7\n");
        printf("%d %d %d %d\n", Tracking_Left1Value, Tracking_Left2Value, Tracking_Right1Value, Tracking_Right2Value);
        Car_Spin_Right(50, 50);
        usleep(1000000);
    }
    // 1110
    else if (Tracking_Left1Value == HIGH && Tracking_Left2Value == HIGH && Tracking_Right1Value == HIGH && Tracking_Right2Value == LOW) {
        printf("RES8\n");
        printf("%d %d %d %d\n", Tracking_Left1Value, Tracking_Left2Value, Tracking_Right1Value, Tracking_Right2Value);
        Car_Spin_Left(50, 50);
        usleep(100000);
    }
    else if (Tracking_Left1Value == HIGH && Tracking_Left2Value == HIGH && Tracking_Right1Value == HIGH && Tracking_Right2Value == HIGH) {
        printf("RES9\n");
        printf("%d %d %d %d\n", Tracking_Left1Value, Tracking_Left2Value, Tracking_Right1Value, Tracking_Right2Value);
        Car_Run(70, 70);
    }
...
void tracking_function() { //REVISE SLEEP TIME BEFOREHAND
    int Tracking_Left1Value = digitalRead(Tracking_Left1);
    int Tracking_Left2Value = digitalRead(Tracking_Left2);
    int Tracking_Right1Value = digitalRead(Tracking_Right1);
    int Tracking_Right2Value = digitalRead(Tracking_Right2);
